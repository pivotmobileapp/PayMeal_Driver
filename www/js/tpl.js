			    ...
			    html+='<ons-row>';
			        ...
			        html+='<ons-col >';
			            ...
			            html+='<div class="table mb10">';
			               html+='<div class="col">';
			                  html+='<span class="tag '+val.trans_type_raw+'">'+val.trans_type+'</span>';
			            ...
			            html+='<div class="table">';
			                ...
			                html+='</div>';
			                html+='<div class="col">';
			                    html+='<p><b class="opaque"></b>'+val.delivery_time+'</p>';
			                html+='</div>';
			            html+='</div>';
			            ...
			            html+='<div class="table">';
			                ...
			                html+='</div>';
			                html+='<div class="col">';
			                    html+='<p><b class="opaque">'+getTrans('Task ID','task_id')+': </b>'+val.task_id+'</p>';
			                html+='</div>'; 
			            html+='</div>';
			            ...
			            html+='<div class="table">';
			                ...
			                html+='</div>';
			                html+='<div class="col">';
			                    html+='<p><b class="opaque">'+getTrans('Customer name','customer_name')+': </b>'+val.customer_name+'</p>';                      
			                html+='</div>';
			            html+='</div>';
			            ...
			            if ( val.merchant_id>=1){
			                html+='<div class="table">';
			                   html+='<div class="col a">';
			                       html+="<img class='opaque svg-task' src='lib/images/menu--task/merchant-name.svg' onerror='this.src='merchant-name.png''>";
			                   html+='</div>';
			                   html+='<div class="col">';
			                      html+='<p><b class="opaque">'+getTrans('Merchant name','merchant_name')+': </b>'+val.merchant_name+'</p>';
			                   html+='</div>';
			                html+='</div>';
			            }
			            ...
			            if ( val.order_id>0){
			                html+='<div class="table">';
			                    ...
			                    html+='</div>';
			                    html+='<div class="col">';            
			                    	html+='<p><b class="opaque">'+getTrans('Order No','order_id')+': </b>'+val.order_id+'</p>';  
			                    html+='</div>';
			                 html+='</div>';

			                 html+='<div class="table">';
				                 html+='<div class="col a">';
				                	 html+="<img class='opaque svg-task' src='lib/images/menu--task/order-status.svg' onerror='this.src='order-status.png''>";
				                 html+='</div>';
				                 html+='<div class="col">';
				                 	html+='<p><b class="opaque">'+getTrans('Order status','order_status')+': </b>'+val.order_status+'</p>';
				                 html+='</div>';
			                 html+='</div>';
			                 
			                 html+='<div class="table">';
				                 html+='<div class="col a">';
			                        html+="<img class='opaque svg-task' src='lib/images/menu--task/payment-type.svg' onerror='this.src='payment-type.png''>";
				                 html+='</div>';
				                 html+='<div class="col">';
				                 	html+='<p><b class="opaque">'+getTrans('Payment Type','payment_type')+': </b>'+val.payment_type+'</p>';
				                 html+='</div>';
			                 html+='</div>';
			            }
			            ...
			            html+='<div class="table mb0">';
			                ...
			                html+='</div>';
			                html+='<div class="col">';
			                    html+='<p><b class="opaque">'+getTrans('Delivery address','delivery_address')+': </b>'+val.delivery_address+'</p>';
			                html+='</div>';
			            html+='</div>';
     ...
     html+='<ons-row>';
        html+='<ons-col width="100%" >';
         html+='<div class="table">';
			 ...
			 html+='<p><b class="opaque"></b>'+data.delivery_time+'</p>';                      
             html+='</div>';
          html+='</div>';    
          ...
          html+='<div class="table mtb5">';
			 ...
			 html+='<p><b class="opaque">'+getTrans('Customer name','customer_name')+': </b>'+data.customer_name+'</p>';
             html+='</div>';
          html+='</div>     ';    
          ...
          if (!empty(data.contact_number)){
	          html+='<div class="table">';
	             ...
	             // html+='<p><a class="tel" href="tel:'+data.contact_number+'">'+data.contact_number+'</a></p>';
			 	 html+='<p><b class="opaque">'+getTrans('Contact number','contact_number')+': </b><a class="tel" href="tel:'+data.contact_number+'">'+data.contact_number+'</a></p>';
	             html+='</div>';
	          html+='</div>     ';   
          } 
         ...
         html+='<ons-col class="tag-align">';
	        html+='<span class="tag-crimson tag '+ data.trans_type_raw+' ">'+ data.trans_type +'</span>';
	     html+='</ons-col>';
	...
	html+='<ons-list-item class="back-white normal-shadow" tappable onclick="viewTaskMap('+data.task_id+', '+ "'" +data.task_lat +"'" +', '+ "'" +data.task_lng +"'" +', '+ "'" + data.delivery_address + "'" + ' )"  >';
     html+='<ons-col width="90%" >     ';            
         html+='<div class="table">';
			 ...
			 html+='<p><b class="opaque">'+getTrans('Delivery to','delivery_to')+': </b>'+data.delivery_address+'</p>';
             html+='</div>';
          html+='</div> ';
    html+='</ons-col>';
	        ...
	        html+='<ons-col width="100%" >';
	         ...
	         if (!empty(data.merchant_name)){
		         html+='<div class="table">';
		             ...
		             // html+='<p>'+ data.merchant_name +'</p>';
			 		 html+='<p><b class="opaque">'+getTrans('Merchant name','merchant_name')+': </b>'+data.merchant_name+'</p>';
		             html+='</div>';
		          html+='</div>';   
	         }
	         ...
	         if (!empty(data.dropoff_contact_name)){
	          html+='<div class="table mtb5">';
			     ...
			     html+='<p><b class="opaque">'+getTrans('Contact name','contact_name')+': </b>'+data.dropoff_contact_name+'</p>';
	             html+='</div>';
	          html+='</div>';   
	         }
	         ...
	         html+='<div class="table">';
	             ...
	             html+='</div>';
	             html+='<div class="col">';
			     html+='<p><b class="opaque">'+getTrans('Contact number','contact-number')+': </b><a class="tel" href="tel:'+data.dropoff_contact_number+'">'+data.dropoff_contact_number+'<a/></p>';
	             html+='</div>';
	         html+='</div>';     
	         }
		...
		html+='<ons-list-item class="back-white" tappable onclick="viewDropOffMap()"  >';
	     html+='<ons-col width="90%" >     ';            
	         html+='<div class="table">';
			     ...
			     html+='<p><b class="opaque">'+getTrans('Pickup address','pickup_address')+': </b>'+data.drop_address+'</p>';
